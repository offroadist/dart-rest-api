...
class ChatDetailsCopyWidget extends StatefulWidget {
  const ChatDetailsCopyWidget({
    Key key,
    this.chatUser,
    this.chatRef,
  }) : super(key: key);
  ...
  @override
  _ChatDetailsCopyWidgetState createState() => _ChatDetailsCopyWidgetState();
}

class _ChatDetailsCopyWidgetState extends State<ChatDetailsCopyWidget> {
